...
type ClosingIsInProcessForSendError struct{}

func (err *ClosingIsInProcessForSendError) Error() string {
	return "Cannot send any messages in closing context. Just skip this error."
}
